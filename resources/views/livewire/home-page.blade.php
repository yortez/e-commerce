            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">VapeStore</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varities of electronic
                        cigrarettes
                        like Pod Systems, Disposable Pods, E-Juice and many more.</p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md"
                        src="https://img.freepik.com/premium-vector/cool-vape-electronic-cigarette-character-mascot-playing-guitar-isolated-cartoon-flat-style-design_574864-505.jpg?semt=ais_hybrid"
